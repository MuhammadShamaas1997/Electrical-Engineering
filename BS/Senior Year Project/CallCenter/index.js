...
//console.log(req)
	...
	else {fs.readFile('CallCentre.html', function(error,data){res.end(data);})}
...
io.on('connection', function (socket) {
	...
	//socket.emit('List',{CallersList:logString,AgentsList:logString});  
  socket.on('Type', function (data) {
	...
	//socket.broadcast.emit('List',{CallersList:logString,AgentsList:logString});
